...
<script type="text/javascript">
        ...
        require(
            ...
            function (ec) {
                ...
                for (var i = 0; i < num; i++) {
                	//dataArr.push("${data[i].getSC_CourseName()}"); 
					//alert("${data[i].getSC_CourseName()}");
					//alert("${data[0].getSC_CourseName()}");
				}
                var option = {
                    //是否显示
                    tooltip: {
...
<body>
	...
	<div id="wrapper">
		<div id="page-wrapper">
            ...
            <div class="row">
            <a href="/UniversityOfShaft/Analysisscore.do?term=1">1</a>
            <a href="/UniversityOfShaft/Analysisscore.do?term=2">2</a>
            <a href="/UniversityOfShaft/Analysisscore.do?term=3">3</a>
            <a href="/UniversityOfShaft/Analysisscore.do?term=4">4</a>
            <a href="/UniversityOfShaft/Analysisscore.do?term=5">5</a>
            <a href="/UniversityOfShaft/Analysisscore.do?term=6">6</a>
            <a href="/UniversityOfShaft/Analysisscore.do?term=7">7</a>
            <a href="/UniversityOfShaft/Analysisscore.do?term=8">8</a>
            </div>
				<div class="row">
